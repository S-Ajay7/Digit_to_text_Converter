...
public class Digit_to_text_converter extends Thread {
static Timer t;
...
icon=Toolkit.getDefaultToolkit().getImage("C:\\Users\\sajay\\eclipse-workspace\\digit_to_text_converter\\images\\logo4.jpg");
ImageIcon image1=new ImageIcon("C:\\Users\\sajay\\eclipse-workspace\\digit_to_text_converter\\images\\b8.jpg");
JLabel i1=new JLabel(image1);
i1.setBounds(0,0,832,550);
ImageIcon image2=new
ImageIcon("C:\\Users\\sajay\\eclipse-workspace\\digit_to_text_converter\\images\\NEC_Logo-00.png");
JLabel i2=new JLabel(image2);
i2.setBounds(20,40,139,90);
ImageIcon image3=new
ImageIcon("C:\\Users\\sajay\\eclipse-workspace\\digit_to_text_converter\\images\\b13.jpg");
...
static void fill1(){
	...
	f2=new Frame("DIGIT TO TEXT");
	 ...
	 ImageIcon image1=new ImageIcon("C:\\Users\\sajay\\eclipse-workspace\\digit_to_text_converter\\images\\b16.jpg");
	 JLabel i1=new JLabel(image1);
	...
	static void frame3() {
	 final Frame f3=new Frame("DIGIT TO TEXT");

	 ImageIcon image1=new ImageIcon("C:\\Users\\sajay\\eclipse-workspace\\digit_to_text_converter\\images\\b24.jpg");
	 JLabel i1=new JLabel(image1);
	...
	final JTextArea mta1=new JTextArea();
	...
	final JTextArea mta2=new JTextArea();
	...
	Digit_to_text_converter o=new Digit_to_text_converter();
	o.start();
	}
	public void run() {
	...
	private static String DigitToText(long n) {
	...
	String ft[]=
	{"","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fiften","Sixteen","Seventeen","Eighteen","Nineteen"};
	String[] tn=
